/// [Build a Custom iOS Segmented Control With SwiftUI | by Frank Jia | Better Programming](https://betterprogramming.pub/custom-ios-segmented-control-with-swiftui-473b386d0b51)
...
//            .animation(Animation.linear(duration: SegmentedPicker.AnimationDuration))
    ...
    private func onItemTap(index: Int) {
        guard index < self.items.count else {https://betterprogramming.pub/simultaneously-scrolling-scrollviews-in-swiftui-2e8ef70ee993            return
        }
